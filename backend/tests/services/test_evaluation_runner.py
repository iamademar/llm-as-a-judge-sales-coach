...
def test_evaluation_runs_and_produces_report(eval_csv_fixture, output_json_path):
    ...
    with patch("app.services.evaluation_runner.score_transcript") as mock_scorer:
